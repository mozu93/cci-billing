...
class _BaseReportWidget(QWidget):
    ...
    def _build(self):
        ...
        top.addWidget(QPushButton("更新")).clicked.connect(self._load)
        top.addWidget(QPushButton("CSV出力")).clicked.connect(self._export_csv)
        top.addWidget(QPushButton("Excel出力")).clicked.connect(self._export_excel)
        top.addStretch()
